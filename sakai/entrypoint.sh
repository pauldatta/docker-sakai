...
# url@javax.sql.BaseDataSource=jdbc:mysql://${DB_ENV_MYSQL_HOST}:3306/${DB_ENV_MYSQL_DATABASE}?characterEncoding=UTF-8&useServerPrepStmts=false&cachePrepStmts=true&prepStmtCacheSize=4096&prepStmtCacheSqlLimit=4096
